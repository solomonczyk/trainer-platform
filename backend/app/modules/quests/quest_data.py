...
QA_QUEST = QuestDefinition(
    ...
    steps=[
        ...
        # ---- Step 4: Branching Decision about Release Risk ----
        {
                ...
                "options": [
                    {
                        ...
                        "next_step_id": "qa_step_05a_fields",
                    },
                    {
            ...
            "evaluation_mode": "deterministic",
            "next_step_rules": {
                "default": "qa_step_05a_fields",
                "by_choice": {
                    "block_release": "qa_step_05a_fields",
                    "release_with_monitoring": "qa_step_05a_fields",
                    "delay_for_analysis": "qa_step_05a_fields",
                },
            },
        ...
        {
            "step_id": "qa_step_05a_fields",
            "step_type": "multiple_choice",
            "story_context_key": "quest.qa.payment_defect.step05a.context",
            "prompt_key": "quest.qa.payment_defect.step05a.prompt",
            "interaction": {
                "choices": [
                    {"id": "title", "text_key": "quest.qa.payment_defect.step05a.opt_title", "is_correct": True},
                    {"id": "environment", "text_key": "quest.qa.payment_defect.step05a.opt_environment", "is_correct": True},
                    {"id": "preconditions", "text_key": "quest.qa.payment_defect.step05a.opt_preconditions", "is_correct": True},
                    {"id": "steps_to_reproduce", "text_key": "quest.qa.payment_defect.step05a.opt_steps", "is_correct": True},
                    {"id": "actual_result", "text_key": "quest.qa.payment_defect.step05a.opt_actual", "is_correct": True},
                    {"id": "expected_result", "text_key": "quest.qa.payment_defect.step05a.opt_expected", "is_correct": True},
                    {"id": "severity_priority", "text_key": "quest.qa.payment_defect.step05a.opt_severity", "is_correct": True},
                    {"id": "evidence_attachments", "text_key": "quest.qa.payment_defect.step05a.opt_evidence", "is_correct": True},
                    {"id": "impact_analysis", "text_key": "quest.qa.payment_defect.step05a.opt_impact", "is_correct": True},
                    {"id": "assignee_name", "text_key": "quest.qa.payment_defect.step05a.opt_assignee", "is_correct": False},
                    {"id": "sprint_name", "text_key": "quest.qa.payment_defect.step05a.opt_sprint", "is_correct": False},
                ],
                "min_selections": 5,
                "max_selections": 11,
            },
            "evaluation_mode": "deterministic",
            "consequences": {"evidence_quality": 10, "decision_quality": 5},
        ...
        {
            "step_id": "qa_step_05b_severity",
            "step_type": "single_choice",
            "story_context_key": "quest.qa.payment_defect.step05b.context",
            "prompt_key": "quest.qa.payment_defect.step05b.prompt",
            "interaction": {
                "options": [
                    {
                        "id": "critical_critical",
                        "text_key": "quest.qa.payment_defect.step05b.opt_critical_critical",
                        "is_correct": True,
                        "consequence": {"decision_quality": 15, "evidence_quality": 5},
                    },
                    {
                        "id": "major_high",
                        "text_key": "quest.qa.payment_defect.step05b.opt_major_high",
                        "is_correct": False,
                        "consequence": {"decision_quality": 5, "evidence_quality": -5},
                    },
                    {
                        "id": "minor_low",
                        "text_key": "quest.qa.payment_defect.step05b.opt_minor_low",
                        "is_correct": False,
                        "consequence": {"decision_quality": -10, "evidence_quality": -10},
                    },
                ],
            },
            "evaluation_mode": "deterministic",
            "consequences": {"decision_quality": 5, "evidence_quality": 5},
        ...
        {
            "step_id": "qa_step_05c_title",
            "step_type": "free_text",
            "story_context_key": "quest.qa.payment_defect.step05c.context",
            "prompt_key": "quest.qa.payment_defect.step05c.prompt",
            "interaction": {
                "max_length": 300,
                "min_length": 0,
                "placeholder_key": "quest.qa.payment_defect.step05c.placeholder",
                "ai_rubric": {
